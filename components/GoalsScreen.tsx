    ...
    <div className="font-display bg-background-light dark:bg-background-dark min-h-screen">
      <div className="relative mx-auto flex h-auto min-h-screen w-full max-w-md flex-col group/design-root overflow-x-hidden pb-24">
        ...
        <div className="flex flex-wrap gap-3 px-4">
          <div className="flex min-w-[100px] flex-1 flex-col gap-1.5 rounded-xl p-4 glassmorphism">
            <p className="text-muted-gray dark:text-gray-300 text-sm font-medium leading-normal">Meals Logged</p>
            <p className="text-deep-blue dark:text-blue-300 tracking-tighter text-3xl font-black leading-tight">3</p>
          </div>
          <div className="flex min-w-[100px] flex-1 flex-col gap-1.5 rounded-xl p-4 glassmorphism">
            <p className="text-muted-gray dark:text-gray-300 text-sm font-medium leading-normal">Today's Calories</p>
            <p className="text-deep-blue dark:text-blue-300 tracking-tighter text-3xl font-black leading-tight">1,250</p>
          </div>
          <div className="flex min-w-[100px] flex-1 flex-col gap-1.5 rounded-xl p-4 glassmorphism">
            <p className="text-muted-gray dark:text-gray-300 text-sm font-medium leading-normal">AI Confidence</p>
            <p className="text-deep-blue dark:text-blue-300 tracking-tighter text-3xl font-black leading-tight">92%</p>
          </div>
        </div>

        {/* Daily Goals Breakdown */}
        <div className="flex items-center justify-between px-4 pb-3 pt-8">
          <h2 className="text-base-text dark:text-white text-[22px] font-bold leading-tight tracking-[-0.015em]">Your Daily Goals</h2>
          <button className="flex items-center gap-1 text-primary dark:text-blue-300 text-sm font-bold hover:underline">
        ...
        <div className="mx-4 rounded-xl p-4 glassmorphism">
          <div className="flex items-center justify-between">
            <div className="text-center">
              <p className="text-muted-gray dark:text-gray-300 text-sm font-medium">Calories</p>
              <p className="text-deep-blue dark:text-blue-300 text-2xl font-black leading-tight tracking-tighter">2,200</p>
              <p className="text-muted-gray dark:text-gray-400 text-xs">kcal</p>
            </div>
            <div className="h-16 w-px bg-gray-200 dark:bg-gray-700"></div>
            <div className="text-center">
              <p className="text-muted-gray dark:text-gray-300 text-sm font-medium">Protein</p>
              <p className="text-deep-blue dark:text-blue-300 text-2xl font-black leading-tight tracking-tighter">150</p>
              <p className="text-muted-gray dark:text-gray-400 text-xs">grams</p>
            </div>
            <div className="h-16 w-px bg-gray-200 dark:bg-gray-700"></div>
            <div className="text-center">
              <p className="text-muted-gray dark:text-gray-300 text-sm font-medium">Carbs</p>
              <p className="text-deep-blue dark:text-blue-300 text-2xl font-black leading-tight tracking-tighter">250</p>
              <p className="text-muted-gray dark:text-gray-400 text-xs">grams</p>
            </div>
            <div className="h-16 w-px bg-gray-200 dark:bg-gray-700"></div>
            <div className="text-center">
              <p className="text-muted-gray dark:text-gray-300 text-sm font-medium">Fat</p>
              <p className="text-deep-blue dark:text-blue-300 text-2xl font-black leading-tight tracking-tighter">70</p>
              <p className="text-muted-gray dark:text-gray-400 text-xs">grams</p>
            </div>
          </div>
        </div>
